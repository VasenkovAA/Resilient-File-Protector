...
int main(int argc, char *argv[]) {
    ...
    if (lang == "ru") {
        // Загрузка стандартного перевода Qt
        if (qtTranslator.load("qt_ru",
            ...
            qWarning() << "Qt Russian translation not found";
        }

        // Поиск перевода приложения
        ...
        if (!loaded) {
            qWarning() << "Russian translation not found. Using English.";
        }
    }
